...
private:
    ...
    // Update only the body text and result badge on the current screen without
    // re-creating it.  Call this while a test is in progress.
    ...
    void        *_lv_badge_label = nullptr;   // lv_obj_t* cast to void*
};
